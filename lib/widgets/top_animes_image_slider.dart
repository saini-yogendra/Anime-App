...
import 'package:carousel_slider/carousel_controller.dart' as slider; // Import with alias
...
class _TopAnimeImageSliderState extends State<TopAnimeImageSlider> {
  ...
  // Ensure we're using CarouselSliderController from carousel_slider package
